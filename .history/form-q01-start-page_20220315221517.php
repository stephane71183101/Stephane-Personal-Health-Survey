...
<body>
    ...
    <div class="container-fluid pb-5 text-center text-white bg-info">
        ...
        <div class="row">
        <div class="col-sm-2.4 text-start">Ungesund</div>
        <div class="col-sm-2">Eher ungesund</div>
        <div class="col-sm-2">Eher gesund</div>
        <div class="col-sm-2">Gesund</div>
        <div class="col-sm-2 text-end">Sehr gesund</div>
        </div>    
        <input type="range" class="form-range pb-2" min="0" max="4" step="1" id="my-range">
