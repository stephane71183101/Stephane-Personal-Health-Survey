...
<footer class="fixed-bottom">
    ...
    <div class="container pt-0">
        ...
        <section class="mb-0">
        <!-- Facebook -->
            <a class="btn btn-link btn-floating btn-lg text-dark m-1" href="#" role="button" data-mdb-ripple-color="dark"><img src="images/facebook.png" alt="Facebook-Logo" width="4%"></a>
