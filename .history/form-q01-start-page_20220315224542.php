    ...
    <div class="container-fluid">
        ...
        <div class="nav justify-content-end" id="navbarNav">
            <form class="d-flexme-2">
                <button class="btn btn-outline-white" type="submit">Vorige Seite</button>
                <button class="btn btn-outline-white" type="submit">Nächste Seite</button>
            </form>
        </div>
    </div>
    </nav>
...
<body>
    ...
    <div class="container-fluid pb-5 text-center text-white bg-info">
        ...
        <div class="container-fluid px-0 pb-2 small">
        <div class="row g-0">
