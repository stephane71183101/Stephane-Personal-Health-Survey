...
<header>
    ...
    <div class="container-fluid pb-5 text-center text-white">
        ...
        <input type="range" id="customRange1" class="form-range mb-5" min="0" max="4" step="1" id="my-range">
        <input type="reset" id="customRange1" class="border-0 bg-white rounded text-info" value="Zurücksetzen">
        </form>
        </div>    
    </div>
