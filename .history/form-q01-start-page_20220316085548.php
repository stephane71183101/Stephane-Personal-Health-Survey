...
<header>
    ...
    <div class="container-fluid pb-5 text-center text-white">
        <div  class="container col-10">
        <form>
        <label for="customRange" class="form-label mb-4">Wie gesund bist du körperlich?</label>
        ...
        <input type="range" id="customRange" class="form-range mb-5" min="0" max="4" step="1">
